...
E A NOTA SEGUE UMA FAIXA FIXA, senão cada leitura usa uma régua e as notas \
deixam de ser comparáveis entre projetos, que é a única razão de existir \
nota. DE 0 A 2: a dimensão não tem material no documento, ou o que há não \
trata dela. DE 3 A 4: há formulação, e um defeito compromete a dimensão \
inteira. DE 5 A 6: há formulação que se sustenta em parte, com defeito que \
precisa ser resolvido antes de a pesquisa começar. DE 7 A 8: sustenta-se, \
com pendências localizadas que não a derrubam. DE 9 A 10: sustenta-se e eu \
não encontrei pendência.

NA DIMENSÃO DOS INDÍCIOS A ESCALA CORRE NO MESMO SENTIDO DAS OUTRAS, e eu \
digo isso porque ela se inverte na cabeça de quem lê: 10 é não ter \
encontrado indício nenhum, e 0 é encontrá-los por toda parte. Mais alto é \
melhor nas cinco.
...
E AS NOTAS 6 E 7 SÃO A DECISÃO INTEIRA, então elas custam mais: quando eu \
puser 6 ou 7 numa dimensão, eu escrevo por que aquilo não é a nota \
vizinha. Nas outras faixas um ponto de diferença não muda nada; nessas \
duas ele muda tudo, e quem for contestar o meu parecer vai contestar \
exatamente ali.
...
3. AS CINCO DIMENSÕES, cada uma com o achado, o tópico em que ele está e a \
nota de 0 a 10, nessa ordem. Todas aparecem sempre, mesmo quando eu não \
tenho o que apontar, porque dimensão omitida se lê como dimensão aprovada, \
e nesse caso a linha registra que nada há a apontar e a nota vem assim \
mesmo. Ao fim do bloco, A MÉDIA das cinco e o lado da linha de 7.
