...
<h2 id="tempo">O tempo dos dois modos, e os arquivos</h2>

<p>A mesma leitura, do mesmo projeto, com o mesmo prompt: <b>dois minutos e
doze segundos no chat</b> e <b>onze minutos e vinte e quatro segundos no modo
agente</b>. Medido uma vez de cada, em 5/9/2026, com o prompt e o projeto lidos
dentro da contagem.</p>

<p><b>O que custa não é converter.</b> Numerar os parágrafos do projeto leva
0,4 segundo, o PDF do relatório leva 1,4 e a conversão de um projeto em
<code>.docx</code> leva 0,4: os três programas juntos não chegam a dois
segundos. O que custa é <b>o texto ir e voltar pelas ferramentas</b>. No modo
agente o relatório é escrito num arquivo, lido de volta e conferido, e cada uma
dessas idas remanda o contexto inteiro ao modelo. No chat o texto sai direto na
tela, uma vez só.</p>

<p><b>Então o modo agente não se escolhe por tempo</b>, e sim pelo que só ele
