...
<p><b>Não há média.</b> As quatro notas por dimensão são o diagnóstico de onde
...
<h3>Cada dimensão sai em dois parágrafos</h3>

<p>Cada um abre pelo seu rótulo. O primeiro, <b>Descrição</b>, descreve o que o projeto traz naquela dimensão, com as
